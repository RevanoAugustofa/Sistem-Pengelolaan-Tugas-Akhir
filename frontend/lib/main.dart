...
import 'package:frontend/views/KoorProdi/Dosen/import_dosen.dart' as kp_import_dsn;
    ...
    return  GetMaterialApp(
      ...
      // home: DashboardAdm(),
       getPages: [
        ...
        GetPage(name: '/importDataDosenKp', page: () => const kp_import_dsn.ImportDataDosenPage()),
