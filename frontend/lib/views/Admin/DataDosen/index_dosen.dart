    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return RefreshIndicator(
          onRefresh: () async => controller.fetchDosen(),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () => Get.toNamed('/importDataDosenAdm'),
                                  ...
                                  DataCell(Row(
                                    children: [
                                      IconButton(
                                        ...
                                        onPressed: () => Get.to(() => EditDosenPage(dosen: dosen)),
                                      ),
                                      IconButton(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Apakah Anda yakin ingin menghapus dosen ${dosen.namaDosen}? Tindakan ini tidak dapat dibatalkan.",
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        controller.deleteDosen(dosen.id!);
                        Get.back();
                      },
                      style: ElevatedButton.styleFrom(
                        padding: const EdgeInsets.symmetric(vertical: 15),
