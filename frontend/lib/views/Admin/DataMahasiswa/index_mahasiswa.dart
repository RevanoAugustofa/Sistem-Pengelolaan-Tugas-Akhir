...
class IndexMahasiswaPage extends StatefulWidget {
  ...
  @override
  State<IndexMahasiswaPage> createState() => _IndexMahasiswaPageState();
}

class _IndexMahasiswaPageState extends State<IndexMahasiswaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        var displayedMahasiswa = filteredMahasiswa.isEmpty ? [] : filteredMahasiswa.sublist(startIndex, endIndex);
        ...
        return RefreshIndicator(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // 1. Search Bar (Posisi di atas sesuai gambar)
                Container(
                  height: 50,
                ...
                // 2. Buttons Tambah & Import (Dibungkus Expanded agar lebarnya rata)
                Row(
                  children: [
                    Expanded(
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () => Get.toNamed('/importDataMahasiswaAdm'),
                      ...
                      SingleChildScrollView(
                        ...
                        child: ConstrainedBox(
                          ...
                          child: DataTable(
                            ...
                            rows: List.generate(displayedMahasiswa.length, (index) {
                              var mhs = displayedMahasiswa[index];
                              return DataRow(
                                  ...
                                  DataCell(Row(
                                    children: [
                                      IconButton(
                                        ...
                                        onPressed: () => Get.to(() => EditMahasiswaPage(mahasiswa: mhs)),
                                      ),
                                      IconButton(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Apakah Anda yakin ingin menghapus mahasiswa ${mhs.namaMahasiswa}? Tindakan ini tidak dapat dibatalkan.",
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        controller.deleteMahasiswa(mhs.id!);
                        Get.back();
                      },
                      style: ElevatedButton.styleFrom(
                        padding: const EdgeInsets.symmetric(vertical: 15),
