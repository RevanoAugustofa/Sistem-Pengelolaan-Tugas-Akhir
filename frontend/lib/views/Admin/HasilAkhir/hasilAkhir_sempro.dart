...
class HasilSemproAdminTable extends StatefulWidget {
  final String searchQuery;
  const HasilSemproAdminTable({super.key, required this.searchQuery});

  @override
  State<HasilSemproAdminTable> createState() => _HasilSemproAdminTableState();
}

class _HasilSemproAdminTableState extends State<HasilSemproAdminTable> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      var filteredData = controller.listHasilSempro.where((item) {
                ...
                if (filteredData.isEmpty)
                  const Center(
                    child: Padding(
                      ...
                      child: Text("Belum ada data hasil sempro", style: TextStyle(color: Colors.grey)),
                    ),
                  )
                else
