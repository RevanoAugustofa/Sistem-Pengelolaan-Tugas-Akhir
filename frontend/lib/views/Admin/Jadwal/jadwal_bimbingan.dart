  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      var filteredData = controller.listJadwalBimbingan.where((item) {
        ...
        return (item['tempat']?.toLowerCase().contains(query) ?? false) ||
               (item['metode']?.toLowerCase().contains(query) ?? false) ||
                            ...
                            return DataRow(
                              ...
                              cells: [
                                ...
                                DataCell(Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: item['metode'].toString().toLowerCase() == 'online' ? Colors.blue.withOpacity(0.1) : Colors.orange.withOpacity(0.1),
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color: item['metode'].toString().toLowerCase() == 'online' ? Colors.blue : Colors.orange,
                                    ),
                                  ),
                                )),
                                DataCell(SizedBox(
                                ...
                                DataCell(Text(
                                  ...
                                  style: TextStyle(
                                    color: item['status'].toString().toLowerCase() == 'tersedia' ? Colors.green : Colors.red,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 10,
                                  ),
                                )),
