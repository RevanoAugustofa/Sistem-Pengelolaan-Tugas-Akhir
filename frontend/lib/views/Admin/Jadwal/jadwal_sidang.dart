...
class JadwalSidangAdminTable extends StatefulWidget {
  ...
  const JadwalSidangAdminTable({super.key, required this.searchQuery});

  @override
  State<JadwalSidangAdminTable> createState() => _JadwalSidangAdminTableState();
}

class _JadwalSidangAdminTableState extends State<JadwalSidangAdminTable> {
