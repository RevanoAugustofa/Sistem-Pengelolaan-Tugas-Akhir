...
class JadwalProposalDosenTable extends StatefulWidget {
  final String searchQuery;
  const JadwalProposalDosenTable({super.key, required this.searchQuery});

  @override
  State<JadwalProposalDosenTable> createState() => _JadwalProposalDosenTableState();
}

class _JadwalProposalDosenTableState extends State<JadwalProposalDosenTable> {
