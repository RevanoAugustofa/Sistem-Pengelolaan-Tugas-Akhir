...
class DetailProposalDosenPage extends StatelessWidget {
  const DetailProposalDosenPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // --- SECTION 2: Jadwal Seminar Proposal ---
            _buildJadwalCard(),
            ...
            // --- SECTION 3: Penilaian Seminar Proposal ---
            const Text(
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  // Catatan: Gunakan package 'dotted_border' jika ingin garis putus-putus persis seperti gambar
            ...
            // Input Nilai
            const Text("Nilai Seminar Proposal", style: TextStyle(fontSize: 13, color: Colors.black87)),
            ...
            const Text("Catatan Revisi", style: TextStyle(fontSize: 13, color: Colors.black87)),
            const SizedBox(height: 8),
            Container(
              decoration: BoxDecoration(
                color: Colors.white,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF3B9DFF), // Biru tombol
                  elevation: 0,
  ...
  // --- HELPER: Kartu Jadwal Seminar Proposal ---
