...
class HasilSemproKPTable extends StatefulWidget {
  final String searchQuery;
  const HasilSemproKPTable({super.key, required this.searchQuery});

  @override
  State<HasilSemproKPTable> createState() => _HasilSemproKPTableState();
}

class _HasilSemproKPTableState extends State<HasilSemproKPTable> {
