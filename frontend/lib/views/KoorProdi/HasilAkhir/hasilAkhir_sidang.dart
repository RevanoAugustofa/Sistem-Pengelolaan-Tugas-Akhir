...
class HasilSidangKPTable extends StatefulWidget {
  final String searchQuery;
  const HasilSidangKPTable({super.key, required this.searchQuery});

  @override
  State<HasilSidangKPTable> createState() => _HasilSidangKPTableState();
}

class _HasilSidangKPTableState extends State<HasilSidangKPTable> {
                      ...
                      rows: List.generate(displayedData.length, (index) {
                        ...
                        return DataRow(
                          ...
                          cells: [
                            ...
                            DataCell(Text(item['nilai_pembimbing_utama']?.toString() ?? "-", style: const TextStyle(fontSize: 11))),
                            DataCell(Text(item['nilai_pembimbing_pendamping']?.toString() ?? "-", style: const TextStyle(fontSize: 11))),
                            DataCell(Text(item['nilai_penguji_utama']?.toString() ?? "-", style: const TextStyle(fontSize: 11))),
                            DataCell(Text(item['nilai_penguji_pendamping']?.toString() ?? "-", style: const TextStyle(fontSize: 11))),
