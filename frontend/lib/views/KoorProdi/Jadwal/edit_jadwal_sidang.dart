...
class EditJadwalSidangPage extends StatefulWidget {
  final JadwalModel jadwal;
  const EditJadwalSidangPage({super.key, required this.jadwal});

  @override
  State<EditJadwalSidangPage> createState() => _EditJadwalSidangPageState();
}

class _EditJadwalSidangPageState extends State<EditJadwalSidangPage> {
  ...
  int? _selectedPembimbingUtama;
  int? _selectedPembimbingPendamping;
  ...
  void initState() {
    ...
    _selectedPembimbingUtama = widget.jadwal.idPembimbingUtama;
    _selectedPembimbingPendamping = widget.jadwal.idPembimbingPendamping;
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<int>(
                value: _selectedPembimbingUtama,
                decoration: const InputDecoration(
                  labelText: "Pembimbing Utama",
                ...
                onChanged: (val) => setState(() => _selectedPembimbingUtama = val),
                validator: (v) => v == null ? "Pembimbing utama wajib dipilih" : null,
              ),
              const SizedBox(height: 20),

              DropdownButtonFormField<int>(
                value: _selectedPembimbingPendamping,
                decoration: const InputDecoration(
                  labelText: "Pembimbing Pendamping",
                  border: OutlineInputBorder(),
                  floatingLabelBehavior: FloatingLabelBehavior.always,
                ),
                items: controller.listDosen.map((d) {
                ...
                onChanged: (val) => setState(() => _selectedPembimbingPendamping = val),
                validator: (v) => v == null ? "Pembimbing pendamping wajib dipilih" : null,
              ),
              const SizedBox(height: 20),
                ...
                onPressed: controller.isLoadingJadwal.value ? null : () {
                  if (_formKey.currentState!.validate()) {
                    final data = {
                      ...
                      "jenis_sidang": widget.jadwal.jenisSidang,
                      "id_pembimbing_utama": _selectedPembimbingUtama,
                      "id_pembimbing_pendamping": _selectedPembimbingPendamping,
