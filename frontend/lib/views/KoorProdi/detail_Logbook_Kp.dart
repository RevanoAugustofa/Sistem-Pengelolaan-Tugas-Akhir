...
class _DetailLogbookPageState extends State<DetailLogbookPage> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(child: Text(widget.mahasiswa.prodi ?? "-", style: const TextStyle(fontSize: 13))),
                      ],
                    ),
