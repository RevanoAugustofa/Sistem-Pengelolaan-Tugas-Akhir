...
class DetailJadwalSidangModal extends StatelessWidget {
  final JadwalModel jadwal;
  const DetailJadwalSidangModal({super.key, required this.jadwal});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _buildDosenItem("Pembimbing Utama", jadwal.pembimbingUtama?.namaDosen ?? "-"),
                  const SizedBox(height: 8),
                  _buildDosenItem("Pembimbing Pendamping", jadwal.pembimbingPendamping?.namaDosen ?? "-"),
